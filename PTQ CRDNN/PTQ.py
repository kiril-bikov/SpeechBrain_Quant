...
def quantize_layer(layer):
    ...
    weight_quant_descriptor = QuantDescriptor(num_bits=8)
    """
...
def quantize(asr, train_data):
    ...
    with torch.no_grad():
        collect_stats(quantized_layers, train_data, num_batches=300, model=asr)
